...
- Tighten menu layout: place pace beside the reset date with an em dash, shorten the Exhaustion label, size analytics sections to their visible contents, and align native controls with trailing checkmarks.
